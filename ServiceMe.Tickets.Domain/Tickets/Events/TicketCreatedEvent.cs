...
public class TicketCreatedEvent : IDomainEvent
{
    ...
    private TicketCreatedEvent(AggregateId id, AggregateId customerId, string title, string description, string? deviceName, TicketType type, TicketStatus status)
    {
        Id = id;
    ...
    public static TicketCreatedEvent Create(Ticket ticket)
